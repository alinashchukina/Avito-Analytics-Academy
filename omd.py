...
def umbrella():
    print(
        ...
        '(1) С желтыми уточками ⛱ (2) В зеленый горошек'
        ' (3) С сердечками ☔ (4) Угольно-чёрного цвета'
    )
    option = ''
    options = ['1', '2', '3', '4']
    while option not in options:
...
def funny(x):
    color = ["С желтыми уточками ⛱", "В зеленый горошек",
             "С сердечками ☔", "Угольно-чёрного цвета"]
    print(
